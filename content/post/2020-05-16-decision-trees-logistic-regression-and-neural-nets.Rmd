---
title: "A Brief Analysis of Predictive Models in Health Care"
author: Scott Miner
date: '2020-05-16'
...
Practitioners convert categorical data to dummy variables and use typical imputation methods to impute missing values.  The most common methodology for creating dummy variables is to create a single column for each of the levels of the categorical variable minus one.  For instance, if a categorical variable contains ten levels, create nine dummy variables [@abbott].
