...
For the discussion topic this week, I will discuss three ways that partial least squares (PLS) are used within the education industry to aid in decision-making.  Also, I will discuss some of the reasoning to use PLS regression instead of standard regression models.
...
The results indicate that students had a moderate level of perception of admission services, while students had a high opinion of extracurricular activities.  The results found a significant relationship between admission services and academic achievement, as well as a significant relationship between extracurricular activities (e.g., volleyball, basketball, and badminton) and academic achievement.  Admission services allow schools to identify qualified candidates for correct placement within the school system [@school].  
